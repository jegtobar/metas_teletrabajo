...
if (isset($_REQUEST['id_meta'])){
    ...
    $query = "SELECT b.ID_META_DETALLE,
              ...
              WHERE B.ID_META =".$id_meta."AND B.CODAREA=".$cod_area;
    $stid = oci_parse($conn, $query);
    oci_execute($stid, OCI_DEFAULT);
...
<div class="wrapper">
      ...
      <div class="row">
        <div class="col-md-12">
          ...
          <form role="form" method="post" action="actualizar_cumplimiento.php" enctype="multipart/form-data" id="form" autocomplete="off">
           <div class="box-header with-border">
            ...
            <input type="text" class="form-control" disabled placeholder="Nombre de la meta..." name="nombre" value="<?php if (isset($id_meta)){echo $nombre;}?>">
            <br>
            <label style="font-size: 18px">Modalidad</label>
            <select disabled  class="form-control" name="tipo" required>
            ...
            <select disabled  class="form-control" name="modalidad" required>
              <option disabled selected="selected" value="N">Seleccione uno...</option>
            ...
            <div class="input-group mb-3">
              <div class="input-group-prepend">
                <div class="input-group-text">
                  ...
                  <input type="checkbox" disabled  name="poa" <?php if(isset($id_meta)){if($poa == '1'){echo 'checked';}}?> aria-label="poa" value="1">
                </div>
              </div>
            </div>
            <br>
            <div class="input-group mb-3">
              <div class="input-group-prepend">
                <div class="input-group-text">
                  ...
                  <input type="checkbox" disabled  name="estatus" id="estatus" aria-label="estatus" <?php if(isset($id_meta)){if($activa == '1'){echo 'checked value="1"';}}?> value="1" >
                  <br>
                </div>
              </div>
            </div>
            ...
            <div class="box-footer text-right">
                ...
                ?>
                <button type="submit" class="btn btn-primary" id="guardarCumplimiento" name="guardarCumplimiento">Grabar</button>
